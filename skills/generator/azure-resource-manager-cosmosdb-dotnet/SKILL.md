...
└── SubscriptionResource
    ├── RestorableCosmosDBAccountCollection  (list restorable accounts)
    └── ResourceGroupResource
        └── CosmosDBAccountResource
            ...
            ├── CosmosDBSqlRoleDefinitionCollection  (SQL RBAC)
            └── CosmosDBSqlRoleAssignmentCollection  (SQL RBAC)
```
...
| [references/sql-resources.md](references/sql-resources.md) | SQL databases, containers with indexing, partition keys, TTL, unique keys |
| [references/throughput.md](references/throughput.md) | Manual/autoscale throughput, migration between modes |
| [references/mongodb-resources.md](references/mongodb-resources.md) | MongoDB databases and collections with throughput |
| [references/gremlin-resources.md](references/gremlin-resources.md) | Gremlin databases and graphs with indexing, unique keys, conflict resolution |
| [references/cassandra-resources.md](references/cassandra-resources.md) | Cassandra keyspaces and tables with schema definition |
| [references/server-side-programmability.md](references/server-side-programmability.md) | Stored procedures, triggers, UDFs in SQL containers |
| [references/sql-rbac.md](references/sql-rbac.md) | SQL role definitions and role assignments for data-plane RBAC |
| [references/backup-restore.md](references/backup-restore.md) | Continuous backup, periodic backup, point-in-time restore |
